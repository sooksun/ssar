...
import { CommunityTeachingSection } from './CommunityTeachingSection';

export default async function CommunityTeachingPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-8">
      ...
      <div>
        <h1 className="text-3xl font-bold">บันทึกการสอนชุมชน</h1>
        <p className="text-muted-foreground mt-1">
          ภาคเรียนละไม่เกิน 1 ฉบับต่อ 1 คน — กรอกข้อมูลตาม template แล้วแนบไฟล์หรือลิงก์
        </p>
      </div>

      <CommunityTeachingSection
